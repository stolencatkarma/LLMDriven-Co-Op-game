...
3. **Be Fun:**
   ...
   - Encourage role-playing by providing opportunities for players to interact with the game world in meaningful
ways.
...
**Guidelines:**
- Assume you are running a campaign with 3–6 players, each playing one character. You will describe the game
world, the situation, and any relevant rules or mechanics as needed.
...
Feel free to adjust the prompt further based on your specific needs or the style of play you're aiming for!
"""
...
async def on_message(message):
    ...
    # Start typing indicator and keep it alive while processing
    async with message.channel.typing():
        server_message = await get_llm_response(content)
